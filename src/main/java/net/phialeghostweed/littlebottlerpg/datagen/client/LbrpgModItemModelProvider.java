...
public class LbrpgModItemModelProvider extends ItemModelProvider {
    public LbrpgModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
